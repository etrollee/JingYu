...
namespace DAL
{
    ...
    /// 反馈模板
    /// </summary>
    public class FeedbackTemplateRepository : BaseRepository<FeedbackTemplate>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>    
        public IQueryable<FeedbackTemplate> DaoChuData(SysEntities db, string order, string sort,
            string search, params object[] listQuery)
        {
            ...
            return db.FeedbackTemplate.Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        public FeedbackTemplate GetById(SysEntities db, string id)
        {
            return db.FeedbackTemplate.SingleOrDefault(o => o.Id == id);
        }
        ...
        {
            FeedbackTemplate deleteItem = GetById(db, id);
            if (deleteItem != null)
            {
                db.FeedbackTemplate.DeleteObject(deleteItem);
            }
        }
