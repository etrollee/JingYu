...
namespace DAL
{
    ...
    public class SysPersonRepository : BaseRepository<SysPerson>, IDisposable
    {
        ...
        /// <param name="id">主键</param>
        /// <returns>外键实体集合</returns>
        public IQueryable<Merchant> GetRefMerchant(SysEntities db)
        {
            return from m in db.SysPerson
                   from f in m.Merchant
                   select f;
        }
        ...
        /// <param name="id">主键</param>
        /// <returns>外键实体集合</returns>
        public IQueryable<Merchant> GetRefMerchant(SysEntities db, string id)
        {
            return from m in db.SysPerson
                   from f in m.Merchant
                   where m.Id==id
