...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
        ...
        <div class="bigdiv">
            ...
            <div class="editor-field">
                <%: Html.DropDownListFor(model => model.Power,new[]{new SelectListItem(){Text="管理员",Value="1"},
                    new SelectListItem(){Text="客服",Value="2"},new SelectListItem(){Text="商家",Value="3"}},"请选择")%>
