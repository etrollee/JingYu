...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            tabCloseEven();
            addTab("我的工作台", "/Home/Default", "tu1112", false);
...
<body class="easyui-layout">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 76px;
        ...
        <div id="mainlogo">
            <h1 style="margin-left:20px;color:antiquewhite; font-size:xx-large;">鲸语后台管理系统</h1>
        ...
        <div id="mainctrl">
            ...
            <div class="ctr">
                ...
                <li class="zi"><a href="http://www.com" class="v1">帮助中心</a></li>
                <li><a href="#">
