...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="divQuery">
        ...
        <input type='text' id='Value' />
         &nbsp;&nbsp; &nbsp;&nbsp;<%: Html.LabelFor(model => model.MemberName) %>： <input type='text' id='MemberName' />
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            $('#flexigridData').datagrid({
                ...
                striped: true,
                collapsible: true,
                url: '../MerchantRegisterCode/GetData', //获取数据的url
                sortName: 'Id',
                sortOrder: 'desc',
                idField: 'Id',
        ...
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "../MerchantRegisterCode/Edit/" + arr[0].Id;
        ...
        function getView() {
            ...
            if (arr.length == 1) {
                window.location.href = "../MerchantRegisterCode/Details/" + arr[0].Id;
        ...
        function flexiCreate() {
            ...
            window.location.href = "../MerchantRegisterCode/Create";
            return false;
        }
        //删除的按钮
        function flexiDelete() {
            ...
            $.messager.confirm('操作提示', "确认删除这 " + arr.length + " 项吗？", function (r) {
                if (r) {
                    $.post("../MerchantRegisterCode/Delete", { query: arr.join(",") }, function (res) {
                        if (res == "OK") {
                            //移除删除的数据
