...
namespace IBLL
{
    ...
    public interface IMemberGroupBLL
    {
        /// <summary>
        /// 验证会员分组名称是否存在
        /// </summary>
        ...
        /// <returns></returns>
        bool CheckName(MemberGroup entity);
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<MemberGroup> GetByParam(string sysPersonId, string id, int page, int rows, string order, 
        ...
        /// <returns></returns>
        [OperationContract]
        bool Create(ref ValidationErrors validationErrors, MemberGroup entity);
        ...
        /// <returns></returns>
        [OperationContract]
        bool Edit(ref ValidationErrors validationErrors, MemberGroup entity);
    }
}
