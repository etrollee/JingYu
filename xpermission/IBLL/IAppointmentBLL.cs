...
namespace IBLL
{
    ...
    public interface IAppointmentBLL
    {
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<Appointment> GetByParam(string sysPersonId, int id, int page, int rows, string order, 
        ...
        /// <returns></returns>
        [OperationContract]
        bool Edit(ref ValidationErrors validationErrors, Appointment entity);
    }
}
