    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            $('#flexigridData').datagrid({
                ...
                striped: true,
                collapsible: true,
                url: '../RegisterCode/GetRegisterCodeLoginData', //获取数据的url
                sortName: 'Id',
                sortOrder: 'desc',
                idField: 'Id',
                ...
                [[
                    ...
                    { field: 'SerialPort', title: '<%:Html.LabelFor(model=>model.SerialPort)%>', width: 200 },
                    { field: 'LoginTime', title: '<%:Html.LabelFor(model=>model.LoginTime)%>', width: 200 },
        ...
        function flexiDelete() {
            ...
            $.messager.confirm('操作提示', "确认删除这 " + arr.length + " 项吗？", function (r) {
                if (r) {
                    $.post("../RegisterCode/DeleteRegisterCodeLogin", { query: arr.join(",") }, function (res) {
                        if (res == "OK") {
                            //移除删除的数据
