...
namespace DAL
{
    public class AppointmentRepository : BaseRepository<Appointment>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>    
        public IQueryable<Appointment> DaoChuData(SysEntities db, string order, string sort,
            string search, params object[] listQuery)
        {
            ...
            return db.Appointment.Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <returns>反馈模板</returns>
        public Appointment GetById(SysEntities db, int id)
        {
            return db.Appointment.SingleOrDefault(o => o.Id == id);
        }

        /// <summary>
        /// 通过主键id，获取反馈模板--查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>反馈模板</returns>
        ...
        {
            Appointment deleteItem = GetById(db, id);
            if (deleteItem != null)
            {
                db.Appointment.DeleteObject(deleteItem);
            }
        }
        ...
        public void Delete(SysEntities db, string[] deleteCollection)
        {
            ...
            IQueryable<Appointment> collection = from f in db.Appointment
